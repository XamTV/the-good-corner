...
export type ReadAdsQuery = { __typename?: 'Query', readAds: Array<{ __typename?: 'Ad', id: string, title: string, description: string, location: string, owner: string, price: number, picture: string, tags: Array<{ __typename?: 'Tag', id: string, title: string }> }> };
